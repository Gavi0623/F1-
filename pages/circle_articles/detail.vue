<template>
  <view class="container">
    <unicloud-db ref="udb" v-slot:default="{data, loading, error, options}" :options="options" :collection="collectionList" field="user_id,title,description,tab,province,content,excerpt,article_status,last_comment_user_id,picurls,publish_date,publish_ip,last_modify_date,last_modify_ip" :where="queryWhere" :getone="true" :manual="true">
...
<script>
  ...
  import { enumConverter } from '../../js_sdk/validator/circle_articles.js'
