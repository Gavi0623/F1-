<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="tab" label="标签">
        <uni-easyinput placeholder="标签" v-model="formData.tab" trim="both"></uni-easyinput>
      </uni-forms-item>
...
<script>
  import { validator } from '../../js_sdk/validator/circle_articles.js';

  const db = uniCloud.database();
  const dbCollectionName = 'circle_articles';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("user_id,title,description,tab,province,content,excerpt,article_status,last_comment_user_id,picurls,publish_date,publish_ip,last_modify_date,last_modify_ip").get().then((res) => {
