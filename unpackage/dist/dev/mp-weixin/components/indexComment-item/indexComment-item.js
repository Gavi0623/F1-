...
/* harmony import */ var _indexComment_item_vue_vue_type_template_id_11b63828_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./indexComment-item.vue?vue&type=template&id=11b63828&scoped=true& */ 656);
/* harmony import */ var _indexComment_item_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./indexComment-item.vue?vue&type=script&lang=js& */ 658);
...
/* harmony import */ var _indexComment_item_vue_vue_type_style_index_0_id_11b63828_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./indexComment-item.vue?vue&type=style&index=0&id=11b63828&lang=scss&scoped=true& */ 660);
...
var _default2 = {
  ...
  methods: {
    ...
    delComment: function delComment() {
      var _this = this;
      if (!_store.store.hasLogin) return;
      if (this.isCurrentUser || this.uniIDHasRole('admin') || this.uniIDHasRole('Home Manager')) {
    ...
    removeComment: function removeComment() {
      ...
      if (this.item.comment_type === 0) {
        ...
        db.collection("news_comments").where({
          ...
          // 更新文章的评论数
          utilsObj.operation("news_articles", "comment_count", _this2.item.article_id, -deletedCount);
        }).catch(function (err) {
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                _context.next = 4;
                return db.collection("news_comments_like").where("article_id == '".concat(_this3.item._id, "' && user_id == $cloudEnv_uid ")).count();
              case 4:
                count = _context.sent;
                console.log(count);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 11:
                ...
                _context2.prev = 14;
                _context2.next = 17;
                return (0, _tools.likeindexCmtFun)(_this4.item._id);
              case 17:
                _context2.next = 25;
                break;
              case 19:
