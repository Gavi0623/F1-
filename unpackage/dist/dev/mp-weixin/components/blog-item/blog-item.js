...
/* harmony import */ var _blog_item_vue_vue_type_template_id_2011eafc___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blog-item.vue?vue&type=template&id=2011eafc& */ 425);
/* harmony import */ var _blog_item_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./blog-item.vue?vue&type=script&lang=js& */ 427);
...
/* harmony import */ var _blog_item_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./blog-item.vue?vue&type=style&index=0&lang=scss& */ 429);
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                _context.next = 4;
                return db.collection("circle_like").where("article_id == '".concat(_this.item._id, "' && user_id == $cloudEnv_uid ")).count();
              case 4:
                count = _context.sent;
                console.log(count);
                if (count.result.total) _this.isLike = true; // 如果点过赞，返回true
              case 7:
              case "end":
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 11:
                ...
                if (!count.result.total) _this2.item.like_count++; // 如果当前登录用户之前没有点赞，实现前端无感点赞交互

                (0, _tools.likeCirFun)(_this2.item._id); // 调用 likeCirFun 函数并获取返回值
              case 14:
              case "end":
